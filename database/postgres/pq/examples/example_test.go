...
func (m *migration_0001) Up(ctx context.Context, tx *versioner.Versioner[*sql.Tx]) error {
...
func (m *migration_0001) Down(ctx context.Context, tx *versioner.Versioner[*sql.Tx]) error {
